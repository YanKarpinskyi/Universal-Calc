...
//     let btnMore = document.getElementById("more__operations");

//     const more__measurments = document.getElementById("more__measurments");
//     const more__operations = document.getElementById("more__operations");
...
//     // document.getElementById("btn__perc").addEventListener("click", handleUnary(
//     //     x => roundTo(x / 100)
//     // ));
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!text) {
        console.error("Result input not found: #result");
        return;
    }
